            ...
            if (courseId === 'ai-engineering-101') {
                if (args[1] === 'intro' || !args[1]) {
                    await ctx.reply('📚 <b>AI Engineering 101</b>\n📖 Module 1: <b>Introduction to AI</b>\n\n' +
                        ...
                        '➡️ <b>Next:</b> Prompt Engineering\n👉 /learn ai-engineering-101 prompt-engineering', { parse_mode: 'HTML' });
                }
                    ...
                    await ctx.reply('📚 <b>AI Engineering 101</b>\n📖 Module 2: <b>Prompt Engineering</b>\n\n' +
                        ...
                        '➡️ <b>Next:</b> Vector Databases\n👉 /learn ai-engineering-101 vector-databases', { parse_mode: 'HTML' });
                }
                else {
                ...
                await ctx.reply('📚 <b>Bot Development</b>\n📖 Module 1: <b>Telegram Bot Basics</b>\n\n' +
                    ...
                    '➡️ <b>Next:</b> Python Bots\n👉 /learn bot-development python-bots', { parse_mode: 'HTML' });
            }
            else {
